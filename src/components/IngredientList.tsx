...
export default function IngredientList({ ingredients, servings, labels }: Props) {
  ...
  return (
    <div className="rounded-lg bg-surface p-6 shadow-elev-sm">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            aria-label="-"
            className="grid h-9 w-9 cursor-pointer place-content-center rounded-lg border-[1.5px] border-ink text-ink hover:bg-accent-100 disabled:cursor-not-allowed disabled:opacity-45"
          >
          ...
          return (
            <Fragment key={i}>
              ...
              <li className="flex items-baseline gap-3 border-b-[1.5px] border-dashed border-ink/20 py-2.5 text-[15px]">
                ...
                {ing.optional && (
                  <span className="rounded-lg border-[1.5px] border-accent-2-700 px-2.5 py-0.5 text-[11px] font-semibold text-accent-2-700">
                    {labels.optional}
                  </span>
                )}
              </li>
